          ...
          <div class="h-full flex flex-col">
            ...
            <div class="flex-1 overflow-auto p-4 space-y-4">
              ...
              <div v-if="cashAccounts.length > 0" class="space-y-2">
                <h4 class="text-sm font-medium text-muted-foreground px-2">Cash Accounts</h4>
                <button
              ...
              <!-- Credit Accounts -->
              <div v-if="creditAccounts.length > 0" class="space-y-2">
                <h4 class="text-sm font-medium text-muted-foreground px-2">Credit Accounts</h4>
                <button
